...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: alloc::borrow::Cow::Borrowed("peaq-node"),
	impl_name: alloc::borrow::Cow::Borrowed("peaq-node"),
	authoring_version: 1,
	spec_version: 104,
	impl_version: 0,
...
mod block_times {
	...
	pub const MILLI_SECS_PER_BLOCK: u64 = (RELAY_CHAIN_SLOT_DURATION_MILLIS / MAX_BLOCK_PROCESSING_VELOCITY) as u64;
